...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Track form fill duration with session-based timestamps for Rails applications}
  spec.description   = %q{A Rails gem that provides controller and model concerns to track how long users take to fill forms. Features include session-based timestamp tracking, customizable expiry times, and model validations.}
